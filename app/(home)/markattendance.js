...
const markattendance = () => {
    ...
    useEffect(() => {
        const fetchEmployeeData = async () => {
            try {
                ...
                console.log("error fetching employee data1111", error);
            }
        };
        fetchEmployeeData();
    }, []);
    ...
    const fetchAttendanceData = async () => {
        try {
            const response = await axios.get(`http://192.168.29.218:9000/attendance`, {
                params: {
            ...
            <Pressable>
                ...
                <View style={{ marginHorizontal: 12 }}>
                    {employees.map((item, key) => (
                        <Pressable onPress={() => router.push({pathname:"/user",
                          params: {
                         ...
                         key={key} style={{flexDirection:"row",alignItems:"center",gap:10}} >
                            <View
                                style={{
                                    width: 50,
                                    height: 50,
                            ...
                            >
                                <Text style={{ color: "white", fontSize: 16 }} key={key}> {item?.employeeName?.charAt(0)}</Text>
                            </View>
                            <View  >
                                <Text >
